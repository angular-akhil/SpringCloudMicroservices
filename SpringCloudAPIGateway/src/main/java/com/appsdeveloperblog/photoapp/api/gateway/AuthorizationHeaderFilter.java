...
//		}
	...
	/*
	 * // @Override Because there can be multiple arguments that can be passed to a
	 * filter class. This method is used to return strings that represent names and
	 * order of arguments that are passed to the filter factory.
	 */
//	public List<String> shortcutFieldOrder() {
		/*
		 * // return Arrays.asList("role","authority"); (The role here is the name of
		 * the instance variable in my Config class. And because it is first in the
		 * list, the value of the argument that we define in the application properties
		 * file will be assigned to this instance variable.)
		 *///	}
