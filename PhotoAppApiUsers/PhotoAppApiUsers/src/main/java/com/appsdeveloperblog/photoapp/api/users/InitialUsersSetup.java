...
public class InitialUsersSetup {
	...
	@Transactional
	@EventListener  // ApplicationReadyEvent object here is an event object that will be published by Spring Framework ,when my application is ready to service requests.
	...
	@Transactional //Because this method performs a modifying operation, it saves to a database.
